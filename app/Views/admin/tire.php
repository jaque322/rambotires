                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="addRecordForm">
                                <input type="hidden" id="csfr_token_id" name="<?= csrf_token() ?>"
                                       value="<?= csrf_hash() ?>"/>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="dimensions" placeholder="Dimensions"
                                           aria-label="dimensions" aria-describedby="basic-addon1">
                                </div>

                                <!-- Desctiption -->
                                <div class="input-group mb-3">
                                    <textarea id="description" name="description" rows="4" cols="60"
                                              class="form-control">
                                        </textarea>
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <!-- Edit Record Form -->
                                        <form id="editForm">
                                            <input type="hidden" id="edit_csfr_token_id" name="<?= csrf_token() ?>"
                                                   value="<?= csrf_hash() ?>"/>
                                            <!-- ID -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="edit_brand"
                                                       placeholder="Select Brand" aria-label="Username"
                                                       aria-describedby="basic-addon1">
                                            </div>
                                            <!-- Dimensions -->
                                            <div class="form-group">
                                                <label for="edit_brand">Dimensions</label>
                                                <input type="text" class="form-control" id="edit_dimensions"
                                                       placeholder="Dimensions">
                                            </div>
                                            <!-- Description -->
                                            <div class="form-group">
                                                <label for="edit_descriptions">Descriptions</label>
                                                <textarea id="edit_descriptions" rows="4" cols="50">
...
<script type="text/javascript"
        src="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.21/b-1.6.3/b-flash-1.6.3/b-html5-1.6.3/b-print-1.6.3/r-2.2.5/datatables.min.js"></script>
<!-- Sweetalert2 -->
